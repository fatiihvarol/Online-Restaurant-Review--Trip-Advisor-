    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="http://localhost/Restaurant_Review/Logs.php" class="cta">Logs</a></li>
            ...
            <tbody>
                ...
                while ($row = $result->fetch()) {
                    ...
                    echo "
                        ...
                        <td>  
                        <form>
                        <a style='background-color:white;' href='http://localhost/Restaurant_Review/DeleteRestaurant.php?id=$row[RestaurantId]' class='btn'>Delete</a>
                        </td>
                        </tr>
