    ...
    <div class="container my-5">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                if (!isset($_GET["id"])) {
                    header("location:/Restaurant_View/Login");
                    exit();
                }
                $id = $_GET["id"];
                ...
                while ($row1 = $result1->fetch()) {
                    ...
                    echo "
                        ...
                        <td>  
                        <form >
                        <a style='background-color:white;' href='http://localhost/Restaurant_Review/UpdateFood.php?id=$row1[FoodId]' class='btn'>Edit</a>
                        <a style='background-color:white; 'href='http://localhost/Restaurant_Review/DeleteFood.php?id=$row1[FoodId]' class='btn'>Delete</a>
            ...
            <tbody>
                ...
                while ($row2 = $result2->fetch()) {
                    ...
                    echo "
                        ...
                        <td>  
                        <form >
                        <a style='background-color:white;' href='http://localhost/Restaurant_Review/BeverageUpdate.php?id=$row2[BeverageId]' class='btn'>Edit</a>
                        <a style='background-color:white; 'href='http://localhost/Restaurant_Review/DeleteBeverage.php?id=$row2[BeverageId]' class='btn'>Delete</a>
